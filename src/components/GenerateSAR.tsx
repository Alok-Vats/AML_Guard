  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      ...
      <div className="bg-dark-surface border border-dark-border rounded-xl shadow-sm overflow-hidden">
        <div className="px-6 py-5 border-b border-dark-border bg-dark-surface/50 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-dark-text-muted mt-1">Review case details before generating SAR</p>
          </div>
          <span className="bg-primary/10 text-primary px-3 py-1 rounded-md border border-primary/20 font-mono text-sm font-bold shadow-sm">Case ID: CASE-102</span>
        </div>
        
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-dark-bg/50 rounded-lg p-5 border border-dark-border/50">
              <h4 className="text-sm font-medium text-white mb-4 flex items-center gap-2">
                <span className="text-lg">🔍</span> Suspicious Accounts Identified
              </h4>
            ...
            <div className="bg-dark-bg/50 rounded-lg p-5 border border-dark-border/50">
              <h4 className="text-sm font-medium text-white mb-4 flex items-center gap-2">
                <span className="text-lg">🚩</span> Flagged Typologies
              </h4>
              <div className="space-y-4">
                <label className="flex items-start gap-3 cursor-not-allowed">
                  ...
                  <div>
                    ...
                    <span className="text-dark-text-muted text-xs">Multiple rapid transactions below $10k</span>
                  </div>
                </label>
                <label className="flex items-start gap-3 cursor-not-allowed">
                  <input type="checkbox" checked readOnly className="w-4 h-4 mt-0.5 rounded bg-dark-bg border-dark-border text-primary focus:ring-primary accent-primary" />
                  <div>
                    ...
                    <span className="text-dark-text-muted text-xs">Complex web of inter-account transfers</span>
                  </div>
                </label>
                <label className="flex items-start gap-3 cursor-not-allowed opacity-50">
                  ...
                  <span className="text-dark-text-muted text-sm font-medium">Terrorist Financing</span>
                </label>
              </div>
            </div>
          </div>
      ...
      <div className="bg-dark-surface border border-dark-border rounded-xl shadow-sm overflow-hidden flex flex-col">
        <div className="p-6 border-b border-dark-border flex justify-between items-center bg-dark-surface/30">
          <h3 className="text-lg font-medium text-white">AI-Assisted SAR Generation</h3>
          {!isGenerating && !isGenerated && (
            <button 
              onClick={handleGenerate}
              className="bg-primary hover:bg-blue-600 text-white px-5 py-2.5 rounded-md text-sm font-medium transition-all shadow-sm shadow-primary/20 flex items-center gap-2"
            >
        ...
        <div className="p-6 min-h-[300px] flex flex-col justify-center">
          {isGenerating ? (
            <div className="py-12 flex flex-col items-center justify-center space-y-5 animate-in zoom-in-95 duration-300">
              ...
              <p className="text-primary font-medium text-lg animate-pulse">Gemini is analyzing transaction cluster...</p>
            ...
            <div className="animate-in fade-in zoom-in-95 duration-500 w-full h-full">
              ...
              <textarea 
                ...
                defaultValue={dummyDraft}
              />
              
              {/* RBAC Logic Buttons */}
              <div className="mt-8 flex justify-end gap-4 border-t border-dark-border pt-6">
                <button className="bg-dark-bg border border-dark-border hover:border-white text-white px-5 py-2.5 rounded-md text-sm font-medium transition-colors">
                  Edit Draft
                </button>
                <div className="relative group flex items-center">
                  ...
                  {role === 'Analyst' && (
                    <div className="absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-danger/10 border border-danger/20 text-danger text-xs py-2 px-3 rounded-md whitespace-nowrap pointer-events-none">
            ...
            <div className="py-16 flex flex-col items-center justify-center text-dark-text-muted border-2 border-dashed border-dark-border rounded-xl bg-dark-bg/30 w-full">
              <span className="text-5xl mb-4 opacity-50 grayscale">🤖</span>
              <p className="text-lg font-medium text-white mb-2">Ready to compile report</p>
              <p className="text-sm">Click "Generate AI SAR Draft" to auto-compile findings from Case #102.</p>
            </div>
          )}
        </div>
      </div>
